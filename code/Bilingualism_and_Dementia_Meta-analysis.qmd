...
format:
  html:
    fig-format: png
    fig-dpi: 300
    fig-path: "/Users/ziyuanli/Documents/Notes/figures for Bayesian Meta-analysis"
  tandf-pdf:
    pdf-engine: xelatex
  tandf-docx:
    fig-format: png
...
create_funnel_plot <- function(estimates_data, meta_ln_bm_est, meta_ln_bm_q2.5, meta_ln_bm_q97.5, filename) {
  ...
  funnel_plot <- estimates_data %>%
    ...
    labs(
      ...
      y = "Posterior Standard Deviation of Difference Estimate"
    ) +
    scale_y_reverse()
