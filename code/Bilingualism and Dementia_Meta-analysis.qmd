...
execute: 
  ...
  warning: false
abstract: |
  You should write a max-250 words abstract.
---
...
: (**#tab-crosssectional**) Cross-sectional Studies of Three Dementia Sub-groups
...
ggplot(draws_summary, aes(x = mean_diff, y = fct_reorder(Study, mean_diff))) +
  ...
  labs(
    title = "Forest Plot of Meta-analytic Effects in MCI\nsub-group",
    x = "Difference in Age at Onset",
    y = "Study",
...
```{r fig9, echo=FALSE, fig.cap="Forest plot of the estimated difference in dementia risk between bilinguals and monolinguals in each study."}
# Reshape data to long format for easier handling
