...
keywords: [Bilingualism • Dementia • Alzheimer’s disease • Bayesian Meta-analysis]
---
...
ggplot(draws_summary, aes(x = mean_diff, y = fct_reorder(Study, mean_diff))) +
  ...
  labs(
    title = "Forest Plot of Meta-analytic Effect in AD Subgroup ",
    x = "Difference in Age at Onset",
    y = "Study",
  ) +
  theme_minimal() +
...
ggplot(draws_summary, aes(x = mean_diff, y = fct_reorder(Study, mean_diff))) +
  ...
  labs(
    title = "Forest Plot of Meta-analytic Effect in FTD Subgroup ",
    x = "Difference in Age at Onset",
    y = "Study",
  ) +
  theme_minimal() +
...
ggplot(draws_summary, aes(x = mean_diff, y = fct_reorder(Study, mean_diff))) +
  ...
  labs(
    title = "Forest Plot of Meta-analytic Effects in MCI Subgroup",
    x = "Difference in Age at Onset",
    y = "Study",
  ) +
  theme_minimal() +
